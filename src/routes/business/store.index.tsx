  ...
  return (
    <DashboardShell title={t("market.store.hubTitle")}>
      <div className="space-y-5">
        ...
        {serviceStore ? (
          <Card className="overflow-hidden rounded-[var(--r-card)] border-0 bg-gradient-to-br from-market-navy to-primary-deep text-primary-foreground shadow-xl">
            <CardContent className="flex flex-wrap items-center gap-4 p-5">
              ...
              <div className="min-w-0 flex-1">
                ...
                <p className="mt-1 text-desc leading-5 text-primary-foreground/65">
