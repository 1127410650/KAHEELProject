...
export const Route = createFileRoute("/admin/verifications")({
  ...
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "مراجعة طلبات توثيق المنشآت ومستنداتها: اعتماد، رفض بسبب، أو طلب استكمال.",
      },
      { property: "og:title", content: "توثيق المنشآت — إدارة سوق تحقّق" },
      { property: "og:description", content: "إدارة طلبات توثيق المنشآت في سوق تحقّق." },
                  ...
                  <div className="flex flex-wrap items-start justify-between gap-2">
                    <div className="min-w-0">
                      <p className="truncate text-sm font-semibold text-foreground">
                        <Link
                          to={`/admin/verifications_/${req.id}`}
