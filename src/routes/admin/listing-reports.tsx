  ...
  head: () => ({
    meta: [
      { title: "بلاغات الإعلانات — إدارة سوق تحقّق" },
      {
        name: "description",
        content:
          "لوحة بلاغات الإعلانات في سوق تحقّق: دورة حالات مقيّدة، إجراءات موثّقة بسبب، وحماية كاملة لهوية المبلّغ.",
      },
      { property: "og:title", content: "بلاغات الإعلانات — إدارة سوق تحقّق" },
