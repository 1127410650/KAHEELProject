...
export const Route = createFileRoute("/admin/listing-reports")({
  ...
  head: () => ({
    meta: [
      { title: "بلاغات الإعلانات — إدارة كحلي" },
      {
        name: "description",
        content:
          "لوحة بلاغات الإعلانات في كحلي: دورة حالات مقيّدة، إجراءات موثّقة بسبب، وحماية كاملة لهوية المبلّغ.",
      },
      { property: "og:title", content: "بلاغات الإعلانات — إدارة كحلي" },
