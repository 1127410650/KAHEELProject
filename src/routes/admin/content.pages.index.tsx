/**
 * لوحة الاستديو والمحتوى — تبويب «صفحات المنصة» (/admin/content/pages)
 *
 * نفس سلوك قائمة الصفحات السابقة بلا أي تغيير وظيفي: `BLOCK_LIBRARY` نفسها،
 * ودورة مسودة/معاينة/نشر/رجوع نفسها. المسودة لا تظهر لزائر عادي أبدًا.
 */
...
export const Route = createFileRoute("/admin/content/pages/")({
  ...
  head: () => ({
    meta: [
      { title: "صفحات المنصة — استوديو كَحيل" },
      {
        name: "description",
        content: "كل صفحات المنصة ونسخها ودورة المسودة والمعاينة والنشر والرجوع من مكان واحد.",
      },
      { property: "og:title", content: "صفحات المنصة — استوديو كَحيل" },
