...
export const Route = createFileRoute("/my/ads/")({
  ...
  head: () => ({
    meta: [
      { title: "إعلاناتي — كَحيل" },
      {
        name: "description",
        content:
          "لوحة إدارة إعلاناتك في كَحيل: المسودات وقيد المراجعة والمنشورة والمنتهية، مع الإيقاف والتجديد والنسخ والأرشفة.",
      },
      { property: "og:title", content: "إعلاناتي — كَحيل" },
      {
