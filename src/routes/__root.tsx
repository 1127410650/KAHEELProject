...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: "منصة كَحيل للسوق والخدمات والحجوزات — Gohail marketplace",
      },
      { property: "og:title", content: "كَحيل — Gohail" },
      {
      ...
      { name: "twitter:title", content: "كَحيل — Gohail" },
      {
      ...
      { property: "og:image:alt", content: "كَحيل — Gohail" },
      { name: "twitter:image", content: canonicalUrl("/og-gohail.png") },
      { name: "twitter:image:alt", content: "كَحيل — Gohail" },
    ],
    links: [
