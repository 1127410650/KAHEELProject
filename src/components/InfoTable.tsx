        ...
        <tbody>
          {visible.map((row, i) => (
            ...
            >
              <th
                scope="row"
                className={`w-2/5 whitespace-nowrap border-b border-border/60 px-3 text-start align-top font-normal text-muted-foreground ${
                  dense ? "py-2" : "py-2.5"
                }`}
              >
                {row.label}
              ...
              <td
                className={`border-b border-border/60 px-3 align-top font-medium ${
                  dense ? "py-2" : "py-2.5"
                }`}
              >
