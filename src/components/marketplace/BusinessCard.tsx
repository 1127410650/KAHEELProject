...
export function BusinessCard({
  ...
  return (
    <div className="flex flex-col rounded-[var(--r-card)] border border-border bg-card p-3.5 shadow-panel transition duration-200 hover:-translate-y-0.5 hover:border-primary/35 hover:shadow-raised">
