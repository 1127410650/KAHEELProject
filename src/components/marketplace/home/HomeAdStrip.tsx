  ...
  if (!campaign) {
    return (
      <section aria-label={ar ? "مساحة إعلانية" : "Ad slot"}>
        ...
        >
          <span className="grid size-9 shrink-0 place-items-center rounded-[var(--r-card)] border-2 border-white bg-[radial-gradient(circle_at_32%_25%,color-mix(in_srgb,var(--kt-primary)_10%,transparent),color-mix(in_srgb,var(--kt-primary)_35%,transparent)_78%)] text-primary sm:size-11">
