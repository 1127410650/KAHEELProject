  ...
  return (
    ...
    >
      ...
      <Link
        ...
        title={detailedLabel}
        className="k-press m-1 inline-flex min-h-9 shrink-0 items-center gap-[var(--sp-2)] rounded-xl bg-[linear-gradient(140deg,var(--kt-header-from),var(--kt-header-to))] px-[var(--sp-3)] text-desc font-black text-white outline-none focus-visible:ring-2 focus-visible:ring-brand-700"
      >
