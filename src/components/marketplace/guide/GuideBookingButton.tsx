...
export function GuideBookingButton({ place }: { place: GuidePlace }) {
  ...
  return (
    <button
      ...
      className="k-press inline-flex min-h-11 w-full items-center justify-center gap-2 rounded-xl bg-gradient-to-l from-primary to-primary/80 px-4 py-2.5 text-[12px] font-black text-primary-foreground shadow-sm sm:w-auto"
    >
