 ...
 *
 * • **كَحيل** — النسخة المعتمدة: شاب بعينين واسعتين بنيّتين «كَحيلتين» وابتسامة
 *   دافئة، لحية قصيرة مرتبة، **طاقية سوداء** (نفس طاقية كَحيلان — فهما ابنا خالة)،
 *   قميص أبيض بياقة مطرّزة ذهبية، صدرية عنابية مطرّزة بالذهبي، حزام قماشي داكن،
 *   سروال أسود فضفاض وجزمة، يقف بثقة هادئة ويد على خصره.
