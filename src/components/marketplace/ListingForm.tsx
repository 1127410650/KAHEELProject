...
export function ListingForm({ listing, initialFieldSlug }: Props) {
  ...
  return (
    ...
    >
      ...
      <div className="sticky bottom-[calc(3.25rem+env(safe-area-inset-bottom))] z-30 -mx-[var(--page-x)] flex flex-col gap-2 border-t border-border bg-background/95 px-[var(--page-x)] py-3 backdrop-blur [@media(max-height:560px)]:flex-row [@media(max-height:560px)]:items-center [@media(max-height:560px)]:gap-3 [@media(max-height:560px)]:py-2 sm:static sm:mx-0 sm:flex-row sm:items-center sm:border-0 sm:bg-transparent sm:px-0 sm:py-0 sm:pt-3 sm:backdrop-blur-none lg:bottom-0">
        {step < STEPS.length - 1 ? (
          <Button
            type="button"
