...
export const PERMISSIONS = [
  ...
  "property_documents.analyze",
  "property_documents.review_analysis",
  "property_documents.approve_analysis",
  "property_documents.apply_analysis",
  "property_documents.view_raw_text",
...
export const PERMISSION_LABELS_AR: Record<Permission, string> = {
  ...
  "property_documents.analyze": "تشغيل التحليل المحلي للمستندات واستخراج البيانات",
  "property_documents.review_analysis": "مراجعة الحقول المستخرجة وتأكيدها أو تعديلها أو رفضها",
  "property_documents.approve_analysis": "اعتماد الحقول الحساسة وحل التعارضات",
  "property_documents.apply_analysis": "تطبيق القيم المعتمدة على ملف المشروع",
  "property_documents.view_raw_text": "عرض النص الخام المستخرج من المستند",
...
export const PERMISSION_LABELS_EN: Record<Permission, string> = {
  ...
  "property_documents.analyze": "Run local document analysis and extract data",
  "property_documents.review_analysis": "Review extracted fields: confirm, edit or reject",
  "property_documents.approve_analysis": "Approve sensitive fields and resolve conflicts",
  "property_documents.apply_analysis": "Apply approved values to the project file",
  "property_documents.view_raw_text": "View the raw extracted text of a document",
