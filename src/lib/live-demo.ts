...
export const LIVE_DEMO_ROLES: LiveDemoRole[] = [
    ...
    queue: [
      {
        ...
        metaAr: "عيادات گحيل · اليوم 6:30 م",
        metaEn: "Gohail Clinics · Today 6:30 PM",
  ...
  },
  {
    ...
    accountAr: "عيادات گحيل",
    accountEn: "Gohail Clinics",
    badgeAr: "صحة وعيادات",
  ...
  },
  {
    ...
    accountAr: "إدارة گحيل",
    accountEn: "Gohail Operations",
    badgeAr: "حساب رسمي",
