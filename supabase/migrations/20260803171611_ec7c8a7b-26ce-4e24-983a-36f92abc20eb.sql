...
BEGIN
  ...
  INSERT INTO public.mkt_listing_images (listing_id, url, alt_text, sort_order, is_cover)
  SELECT _new, url, alt_text, sort_order, is_cover
    FROM public.mkt_listing_images WHERE listing_id = _id;
