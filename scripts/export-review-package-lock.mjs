...
for (const section of ["dependencies", "devDependencies"]) {
  ...
  if (JSON.stringify(expected) !== JSON.stringify(actual)) {
    throw new Error(`Generated lock root does not exactly preserve ${section}.`);
  }
}
